...
module.exports = {
  import: (req, res, next) => {
    ...
    console.log('User autoimport preference:', req.izone.user.p_izone_autoimport)
    let importOnlyEventsMatchingAlias = null
    const autoimport = req.izone.user.p_izone_autoimport
    if (!autoimport && req.izone.import) {
      importOnlyEventsMatchingAlias = req.izone.import
    }

    console.log('importOnly', importOnlyEventsMatchingAlias)
