...
module.exports = {
  import: (req, res, next) => {
    ...
    console.log('ok', req.params.callback_id)
    console.log('ok', req.params.name)
    console.log('ok', req.params.value)

    console.log('ok', req.body.callback_id)
    console.log('ok', req.body.name)
    console.log('ok', req.body.value)
    ...
    console.log('IMPORT!!!!', req.izone.week, req.izone.import)
    if (!req.izone.user) {
