...
module.exports = {
  validateGoogleAuthorization: (req, res, next) => {
    ...
    let userShouldGetAnAuthorizationHelpResponse = (userHasNoValidToken && !refreshToken) || req.izone.getGoogleAuthUrl

    if (tokenCode) {
      userShouldGetAnAuthorizationHelpResponse = false
    }
